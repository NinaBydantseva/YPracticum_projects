...
business_dt = '{{ ds }}'
#-----------------------------------------
def update_d_item(ti, postgres_conn_id, sql):

    psql_conn = PostgresHook(postgres_conn_id)
    ...
    return 200
#-----------------------------------------
def update_d_customer(ti, postgres_conn_id, sql):
    ...
    return 200
#-----------------------------------------
def update_d_city(ti, postgres_conn_id, sql):
    ...
    return 200    
#-----------------------------------------
def update_f_sales(ti, postgres_conn_id, sql):
    ...
    return 200  
#-----------------------------------------
def update_f_customer_retention(ti, postgres_conn_id, sql):
